export const TOPIC_TEMPLATES = [
  ...
  // --- Politics & Leadership ---
  {
    label: "Democracy vs Efficiency",
    topic: "Is democracy the most effective form of government?",
    desc: "Debate the trade-offs between democratic representation/freedoms and the speed/efficiency of authoritarian decision-making."
  },
  {
    label: "Open Borders",
    topic: "Should nations have open borders?",
    desc: "Discuss human rights and economic benefits of free movement vs national security and cultural preservation."
  },
  {
    label: "Term Limits",
    topic: "Should there be term limits for all politicians?",
    desc: "Analyze if limits prevent corruption and stagnation or if they remove experienced leaders and empower lobbyists."
  },
  {
    label: "Gun Control",
    topic: "Strict gun control vs Right to bear arms?",
    desc: "Debate public safety and crime reduction vs individual liberties and self-defense rights."
  },
  {
    label: "Nationalism",
    topic: "Is nationalism a force for good?",
    desc: "Discuss whether national pride builds community and stability or leads to conflict, xenophobia, and war."
  },
  {
    label: "Electoral Systems",
    topic: "Direct Democracy vs Representative Republic?",
    desc: "Debate the fairness of 'one person, one vote' vs systems designed to protect minority interests (like the Electoral College)."
  },
  {
    label: "Military Spending",
    topic: "Should military budgets be significantly reduced?",
    desc: "Argue the necessity of defense and deterrence vs the opportunity cost of funding social programs, healthcare, and education."
  },
  {
    label: "Lobbying",
    topic: "Should corporate lobbying be banned?",
    desc: "Discuss freedom of petition and speech vs the influence of money in politics and policy capture by special interests."
  },
  {
    label: "United Nations",
    topic: "Is the UN effective in maintaining world peace?",
    desc: "Evaluate the successes of international diplomacy vs the failures of the Security Council and enforcement power."
  },
  {
    label: "Nikol Pashinyan",
    topic: "Is Nikol Pashinyan acting in the best interests of Armenia?",
    desc: "Debate his leadership effectiveness, handling of geopolitical challenges, democratic reforms vs security concerns and outcome of conflicts."
  }
];
